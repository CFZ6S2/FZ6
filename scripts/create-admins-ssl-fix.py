#!/usr/bin/env python3
"""
Script para crear las 3 cuentas de administrador con fix para problemas SSL
"""
import os
import sys
import ssl
...
def create_admin(email, gender):
    ...
    try:
        ...
        # Actualizar Firestore con timeout
        ...
        try:
            ...
            print(f"  ⚠️  Advertencia Firestore: {str(fs_error)}")
            print(f"  ℹ️  Los custom claims están configurados, pero verifica Firestore manualmente")
